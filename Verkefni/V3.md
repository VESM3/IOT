...
Tengdu [stilliviðnám](https://cdn-learn.adafruit.com/guides/images/000/002/179/medium800/562-00.jpg) við ESP-inn sem er sendir og stjórnaðu með því hversu hátt heyrist í hátalaranum (e. volume) á hauskúpunni. 
> [!Tip]
...
1. NeoPixel hringur: Tengdu S (IN megin) við pinna 45 á ESP32-S3 (stakur), V í 3.3V línuna og G í GND línuna.
1. Tengdu takka við ESP32 (stakur) og kveiktu á servos á fígúru með honum.
    - Servo-arnir eiga allir að hreyfast lítillega (ca. 25°).
1. Sendu til baka stöðuna (gráður) á öllum servo-unum í JSON frá fígúru.
1. Notaðu NeoPixel hringinn í eitthvað sniðugt.
    - Hugmynd: Tengdu gráður við NeoPixel hring (gauge meter) t.d. kjálkinn.
<!-- 
> [!Tip]
...
1. Búðu til eftirfarandi senu (runa: A-B-C-D) með tveimur ESP32 ([flæðirit](https://raw.githubusercontent.com/VESM3/Kennarar/20bc84d2c8a4a41d2b64bc4b2591e78fd7932592/Verkefni/H24/H24_v3_3.drawio.svg?token=AD4F24J7DA4PVMQ57335BVDHFFEDC)).
    1. A: Ýtt er á takka á ESP32 (stakur), fyrirmæli send um að spila lag hjá fígúru. 
    1. B: Þegar lagið er búið þá eru fyrirmæli send tilbaka frá fígúru til ESP32 (stakur) um að kveikja á grænu LED<sub>1</sub>. 
