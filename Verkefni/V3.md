...
-->
<!-- 1. Láttu svo þetta hefjast á 10 sekúndu fresti. -->
<!-- Skoðaðu [WLAN](https://docs.micropython.org/en/latest/esp32/quickref.html#wlan).  -->
...
Tengdu [stilliviðnám](https://cdn-learn.adafruit.com/guides/images/000/002/179/medium800/562-00.jpg) við ESP (sendir) til að stjórna lit í augunum á fígúru (móttakari). Þú skiptir um lit með að snúa breytiviðnáminu. 
...
1. Tengdu takka við ESP32 (sendir) og kveiktu á öðru auganu (led) á fígúrunni með honum (móttakari). Láttu led (augu) breyta um lit á 1 sek. fresti á fígúru.
1. Sendu til baka litastöðuna í [JSON](https://www.w3schools.com/python/python_json.asp) frá fígúru á 1 sek. fresti.
