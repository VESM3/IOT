...
<details>
<summary>Að tengjast RPi með VNC (í stað RPi Connect)</summary>
<br>

Að keyra VNC server á Raspberry Pi leyfir þér að tengjast **RPi desktop** viðmóti þráðlaust frá fartölvu.
