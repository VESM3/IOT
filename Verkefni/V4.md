...
<!--
> Nánar: [asyncio safnið (micropython)](https://docs.micropython.org/en/latest/library/asyncio.html#), [guide to MicroPython's asynci](https://github.com/peterhinch/micropython-async/tree/master/v3#1-guide-to-asyncio) og [asyncio safnið (python)](https://docs.python.org/3/library/asyncio.html).
-->
