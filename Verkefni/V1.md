...
2. Tengdu RFID við ESP32 og finndu út ID á RFID tagi með ESP32 lesaðgerð, [ESP32 uppsetning og kóðadæmi](https://esp32io.com/tutorials/esp32-rfid-nfc). 
3. Prófaðu RFID les- og skrifaðgerðir með **ESP32**.
4. Settu upp á brauðbretti RC522 RFID og tvö LEDs (rautt og grænt) með ESP32. Notaðu RFID tag til að auðkenna notanda, [sýnidæmi](https://tutorial45.com/arduino-rfid-project-beginners/).
