...
Fyrir servo mótorinn þarftu að sækja [þetta](https://github.com/pvanallen/esp32-getstarted/blob/master/examples/servo.py) klasasafn. Sjá nánar [hér](https://github.com/VESM3/IOT/blob/main/Kodi/servo_motor.py) kóðadæmi og að uppphafstilla min og max á servo.
...
1. Breyttu nú forritun hér að ofan þannig að þegar þekkt kort (úr liðnum hér fyrir ofan) er lesið kemur grænt ljós á NeoPixel-ana í augunum en ef kortið er ekki þekkt kemur rautt ljós. Ljósin eiga að loga í eina sekúndu (má gera með `sleep_ms`).
