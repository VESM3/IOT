...
1. Tengdu tvö LEDS (rautt og grænt) og RFID tags með RC522 til að auðkenna notanda, [sýnidæmi](https://tutorial45.com/arduino-rfid-project-beginners/) (kóðinn er smá brenglaður).
...
1. Búðu til tvo notendur (nafn) og skrifaðu á sitthvort RFID tagið.
1. notaðu `id` af RFID tag fyrir auðkenningu. Þegar notandi skráir sig inn þá birtist á OLED nafn og tími og grænt LED logar. Þegar notandi skráir sig út þá á að birtast á OLED nafn og viðverutíminn ( frá innskráningu ) og rautt LED logar. 
