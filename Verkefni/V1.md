...
3. Skrifaðu nafnið þitt á RFID tag. Notaðu því næst lesaðgerð og birtu nafnið þitt á Serial monitor.
4. Tengdu tvö LEDs (rautt og grænt) við ESP32. Notaðu RFID tag til að auðkenna notanda, [sýnidæmi](https://tutorial45.com/arduino-rfid-project-beginners/).
