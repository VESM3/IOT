...
**Vinnuframlag:** Fyrir hverja kennslulotu (4 x 50 mín) í skóla sem nemandi mætir **ekki**, dregst **2** frá einkunn hjá viðkomandi.

---

#### ESP32 sleep mode 
Ef þú ætlar að nota batterí með ESP32 þá skiptir hvert mA máli. Settu ESP32 í deep sleep mode, en láttu ESP32 vakna á 10 sekúndna fresti til að kveikja á LED í 3 sekúndur, haltu einnig utan um fjölda skipta sem kveikt er á LED í með teljara og birtu í Serial Monitor. Settu svo ESP32 aftur í deep sleep.
