...
1. Búðu til skemmtilega vefsíðu þar sem þú sýnir kunnáttu þína í NiceGUI.
    - Notaðu að minnsta kosti 3 hluti (e. control element).
...
[DHT11](https://components101.com/sensors/dht11-temperature-sensor) er hita- (0°C til 50°C) og rakamælir (20% til 90%). Tengdu DHT11 við ESP32 samkvæmt þessari [mynd](https://github.com/VESM3/IOT/blob/main/Myndir/dht11_tenging.png). Notaðu svo þennan kóða til að sjá hann virka:
```python
...
#### Async MQTT í hefðbundu Python (þ.e.fartölvan) 
...
Notkunin fyrir subscribe (virkar á móti sendinum í sýnidæminu í verkefni 3.2):
```python
import asyncio
...
Dæmi um MQTT sendingar í NiceGUI (virkar á móti móttakaranum í sýnidæminu í verkefni 3.2:
```python
import asyncio
from nicegui import ui, app
from aiomqtt import Client
